...
const demoNotifications = [
    { id: 1, type: 'store', title: 'New store application', text: 'TechZone by Mike R. applied to become a seller', time: '2h ago', read: false, icon: StoreIcon, color: 'text-orange-500 bg-orange-50' },
    { id: 2, type: 'store', title: 'New store application', text: 'HomeEssentials by Tom B. applied to become a seller', time: '3d ago', read: false, icon: StoreIcon, color: 'text-orange-500 bg-orange-50' },
    ...
    return (
        <div className="text-slate-500 mb-28 max-w-3xl">
            <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setNotifications(prev => prev.map(n => ({ ...n, read: true })))} className="text-xs text-orange-500 hover:text-orange-600 font-medium">Mark all read</button>
            </div>
